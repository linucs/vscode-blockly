...
export const FIELD_DESCRIPTORS: FieldDescriptor[] = [
    ...
    { type: 'field_dropdown', label: 'dropdown', hasName: true, scalars: [], structured: ['options'] },
    ...
    { type: 'field_dependent_dropdown', label: 'dependent dropdown', hasName: true, scalars: [], structured: ['options'] },
    { type: 'field_grid_dropdown', label: 'grid dropdown', hasName: true, scalars: [], structured: ['options'] },
    // ── First-party custom fields (webview/custom-fields/*) ──────────────
    { type: 'field_bitmap', label: 'bitmap', hasName: true, scalars: [NUM('width', 'WIDTH', 'width'), NUM('height', 'HEIGHT', 'height')], structured: ['value'] },
    { type: 'field_combobox', label: 'combobox', hasName: true, scalars: [STR('text', 'TEXT', 'value')], structured: ['options'] },
    {
